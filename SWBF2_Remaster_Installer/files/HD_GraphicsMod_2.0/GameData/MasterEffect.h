...
#define MASTEREFFECT_TOGGLEKEY	0x7A	//[depending on keyboard layout] Key used to toggle all MasterEffect effects. See ReShade documentation for more info. 
...
#define USE_HDR_LEVEL		1	//[0 to 2] HDR Level: Rendering bitrate. 0: RGBA8 | 1: RGBA16F | 2: RGBA32F
...
#define USE_HPD  		1	//[0 or 1] Haarm Peter Duiker Filmic Tonemapping: Tonemapping used in Watch Dogs, ripped from the Watch Dogs shaders themselves.
...
#define USE_GRAIN		1	//[0 or 1] Grain: Adds some image grain, looks like when a TV has no signal.
...
#define CartoonEdgeSlope     		0.4    //[0.1 to 8.0] Raise this to filter out fainter edges. You might need to increase the power to compensate. Whole numbers are faster.
...
//DPX
#define DPXRed   			5  	//[1.0 to 15.0] Amount of DPX applies on Red color channel
#define DPXGreen 			6.0  	//[1.0 to 15.0] ""
#define DPXBlue  			4  	//[1.0 to 15.0] ""
...
#define DPXSaturation 			-1  	//[0.0 to 8.0] Adjust saturation of the effect. 1.0 is neutral.
#define DPXRedC   			0.36 	//[0.60 to 0.20] 
#define DPXGreenC 			0.5 	//[0.60 to 0.20]
#define DPXBlueC  			0.5 	//[0.60 to 0.20]
#define DPXBlend 			0.1  	//[0.00 to 1.00] How strong the effect should be.

//LIFTGAMMAGAIN
#define RGB_Lift  		float3(0.900, 0.900, 0.900)  //[0.000 to 2.000] Adjust shadows for Red, Green and Blue.
#define RGB_Gamma 		float3(0.990, 0.990, 1.000)  //[0.000 to 2.000] Adjust midtones for Red, Green and Blue
#define RGB_Gain  		float3(1.050, 1.050, 1.050)  //[0.000 to 2.000] Adjust highlights for Red, Green and Blue

//TONEMAP
#define Gamma       			1.29 	//[0.000 to 2.000] Adjust midtones. 1.000 is neutral. This setting does exactly the same as the one in Lift Gamma Gain, only with less control.
#define Exposure    			-0.090  	//[-1.000 to 1.000] Adjust exposure
#define Saturation  			-0.147 	//[-1.000 to 1.000] Adjust saturation
#define Bleach      			0.000  	//[0.000 to 1.000] Brightens the shadows and fades the colors
#define Defog       			    0.001  	//[0.200 to 1.000] How much of the color tint to remove
#define FogColor 			float3(0.00, 0.00, 2.55) //[0.00 to 2.55, 0.00 to 2.55, 0.00 to 2.55] What color to remove - default is blue

//VIBRANCE
#define Vibrance     			0.55  	//[-1.00 to 1.00] Intelligently saturates (or desaturates if you use negative values) the pixels depending on their original saturation.
#define Vibrance_RGB_balance 		float3(1.00, 1.00, 1.00) //[-10.00 to 10.00,-10.00 to 10.00,-10.00 to 10.00] A per channel multiplier to the Vibrance strength so you can give more boost to certain colors over others

//CURVES
#define Curves_mode        		0	//[0|1|2] Choose what to apply contrast to. 0 = Luma, 1 = Chroma, 2 = both Luma and Chroma. Default is 0 (Luma)
#define Curves_contrast 		0.95 	//[-1.00 to 1.00] The amount of contrast you want
...
#define SepiaPower 			0.068    //[0.00 to 1.00] How much to tint the image

//SKYRIM TONEMAPPING
#define POSTPROCESS			3 	//[1 to 6] Mode of postprocessing you want. Mode 1 uses V1 values, Mode 2 uses V2 values etc
//
#define	EAdaptationMinV1   		0.05 
#define	EAdaptationMaxV1   		0.06
#define	EContrastV1   			1.0
#define	EColorSaturationV1   		0.70 
#define	EToneMappingCurveV1   		9.0 
//	
...
//CROSSPROCESS
#define CrossContrast			0.8  	//[0.5 to 2.00] The names of these values should explain their functions
#define CrossSaturation			0.85  	//[0.5 to 2.00]
#define CrossBrightness			-0.060  //[-0.3 to 0.30]
#define CrossAmount			0.05	//[0.05 to 1.5]

//FILMICPASS
#define Strenght			0.05  	//[0.05 to 1.5] Strength of the color curve altering
#define BaseGamma			1.6	//[0.7 to 2.0] Gamma Curve
#define Fade				0.6	//[0.0 to 0.6] Decreases contrast to imitate faded image
...
#define ReinhardScale			0.7	//[0.0 to 2.0] Amount of applied tonemapping
...
//SPHERICAL TONEMAP
#define sphericalAmount 		0.63	//[0.0 to 2.0] Amount of spherical tonemapping applied...sort of
...
//LENSDIRT
#define fLensdirtIntensity 		1.7	//[0.0 to 2.0] Intensity of lensdirt.
#define fLensdirtSaturation		1.5	//[0.0 to 2.0] Color saturation of lensdirt.
...
#define iLensdirtMixmode		3	//[1 to 4] 1: Linear add | 2: Screen add | 3: Screen/Lighten/Opacity | 4: Lighten

//GAUSSIAN ANAMORPHIC LENSFLARE
#define fAnamFlareThreshold		0.95		//[0.1 to 1.0] Every pixel brighter than this value gets a flare.
#define fAnamFlareWideness		1.5	//[1.0 to 2.5] Horizontal wideness of flare. Don't set too high, otherwise the single samples are visible
#define fAnamFlareAmount		0.145	//[1.0 to 20.0] Intensity of anamorphic flare.
#define fAnamFlareCurve			1.2	//[1.0 to 2.0] Intensity curve of flare with distance from source
#define fAnamFlareColor		float3(1.0,1.0,1.0) //[0.0 to 1.0] R, G and B components of anamorphic flare. Flare is always same color.

//BLOOM
#define iBloomMixmode			2	//[1 to 4] 1: Linear add | 2: Screen add | 3: Screen/Lighten/Opacity | 4: Lighten
#define fBloomThreshold			0.89	//[0.1 to 1.0] Every pixel brighter than this value triggers bloom.
#define fBloomAmount			1.02	//[1.0 to 20.0] Intensity of bloom.
#define fBloomSaturation 		0.8	//[0.0 to 2.0] Bloom saturation. 0.0 means white bloom, 2.0 means very very colorful bloom.
#define fBloomTint 		float3(1.0,0.8,1.0) //[0.0 to 1.0] R, G and B components of bloom tintcolor the bloom color gets shifted to.

//LENZ FLARE
#define LENZDEPTHCHECK 			0    	//[0 or 1] if 1, only pixels with depth = 1 get lens flare, this prevents white objects from getting flare source which would normally happen in LDR
#define fLenzIntensity 			0.4	//[0.2 to 3.0] power of lens flare effect
#define fLenzThreshold 			0.91 	//[0.6 to 1.0] Minimum brightness an object must have to cast lensflare
...
#define iGodraySamples 			8	//[2^x format] How many samples the godrays get
...
#define fGodrayDensity			2	//[0.2 to 2.0] Density of rays, higher means more and brighter rays
#define fGodrayThreshold		0.98    	//[0.6 to 1.0] Minimum brightness an object must have to cast godrays

//ANAMORPHIC LENSFLARE
#define bFlareDepthCheckEnable		0	//[0 or 1] if 1, only pixels with depth = 1 get an anamflare, this prevents white objects from getting flare source which would normally happen in LDR
#define fFlareLuminance 		0.98	//[0.6 to 1.0] bright pass luminance value 
#define fFlareBlur 			100.0	// [1.0 to 9999999] manages the size of the flare
#define fFlareIntensity 		0.2	// [0.2 to 5.0] effect intensity
...
#define AO_TEXSCALE   			1	//[0.25 to 1.0] Scale of AO resolution, 1.0 means fullscreen. Lower resolution means less pixels to process and more performance but also less quality.
...
#define AO_FADE_START			0.55	//[0.0 to 1.0] Distance from camera where AO starts to fade out. 0.0 means camera itself, 1.0 means infinite distance.
#define AO_FADE_END			0.25	//[0.0 to 1.0] Distance from camera where AO fades out completely. 0.0 means camera itself, 1.0 means infinite distance.
...
#define fSSAODarkeningAmount 		2.2	//[0.0 to 5.0] Amount of SSAO corner darkening
#define fSSAOBrighteningAmount  	1.8	//[0.0 to 5.0] Amount of SSAO edge brightening
...
#define iHBAOSamples			10	//[7 to 36] Amount of samples. Higher means more accurate AO but also less performance.
...
#define fHBAOAmount			4.0	//[1.0 to 10.0] Amount of HBAO shadowing.
...
#define DOF_FARBLURCURVE 		100000	//[0.4 to X] Elementary, my dear Watson: Blur power of areas behind focus plane.
#define DOF_BLURRADIUS 			50	//[5.0 to 50.0] Blur radius approximately in pixels. Radius, not diameter.
#define DOF_MANUALFOCUS   		1	//[0 or 1] Enables manual focus. 	
#define DOF_MANUALFOCUSDEPTH 		0.001	//[0.0 to 1.0] Manual focus depth. 0.0 means camera is focus plane, 1.0 means sky is focus plane.
...
#define fRingDOFThreshold  		1.0	//[0.8 to 2.0] Threshold for bokeh brightening. Above this value, everything gets much much brighter. 1.0 is maximum value for LDR games like GTASA, higher values work only on HDR games like Skyrim etc.
...
#define iMagicDOFBlurQuality 		15	//[1 to 30] Blur quality as control value over tap count. Quality 15 produces 721 taps, impossible with other DOF shaders by far, most they can do is about 150.
#define fMagicDOFColorCurve 		4.0	//[1.0 to 10.0] DOF weighting curve.
...
#define bMatsoDOFChromaEnable		0	//[0 or 1] Enables Chromatic Abberation.
...
#define fMatsoDOFBokehCurve		13.0	//[0.5 to 20.0] Bokeh curve.
...
#define fFisheyeZoom			0.498   	//[0.5 to 1.0] some lens zoom to hide bugged edges due to texcoord modification
#define fFisheyeDistortion	 	0.0  	//[-0.3 to 0.3] distortion of image, fish eye effect
#define fFisheyeDistortionCubic		0.0	//[-0.3 to 0.3] distortion of image, fish eye effect, cube based
#define fFisheyeColorshift		-0.005   //[-0.1 to 0.1] Amount of color shifting

//IMAGE GRAIN
#define fGrainSaturation 		0.5	//[0.0 to 2.0] Saturation of Grain. Higher means more colored noise, 0.0 means blacknwhite no TV signal noise.
#define fGrainIntensityBright 		0.04	//[0.0 to 2.0] Intensity of Grain in bright areas.
#define fGrainIntensityMid 		0.031	//[0.0 to 2.0] Intensity of Grain in midtone areas.
#define fGrainIntensityDark 		0.010	//[0.0 to 2.0] Intensity of Grain in dark areas.

//EXPLOSION
#define fExplosionRadius    		0.2    //[0.2 to 100.0] Amount of effect you want.

//SMAA
#define fSMAAThreshold			0.08	//[0.05 to 0.20] Edge detection Threshold. If SMAA misses some edges try lowering this slightly. I prefer between 0.08 and 0.12.
...
#define iSMAAEdgeDetectionMode		100	//[1 to 3] 1: Luma edge detection 2: Color edge detection 3: Depth edge detection
...
//HEAT HAZE
#define fHeatHazeSpeed  		1	//[0.5 to 10.0] Speed of heathaze waves
#define fHeatHazeOffset 		0.8	//[0.5 to 20.0] Amount of image distortion caused by heathaze effect
...
//LED SHADER
#define fLEDCircleSize			5.0	//[10.0 to 50.0] Size of the single LED's
...
//HD6VIGNETTE
#define fHD6VignetteMode 		3	//[1 to 3] Vignette Alignment 1: Left and right | 2: top and bottom | 3: corners.		
#define fHD6VignetteTop			0.3	//[0.3 to 1.5] Top/left (depending on mode) height of bar.
#define fHD6VignetteBottom		0.3	//[0.3 to 1.5] Bottom/right (depending on mode) height of bar.
#define fHD6VignetteRoundness		30	//[0.0 to 100000.0] Amount of circularism (new word invented hoho), 0 means linear vignette, 100000.0 means rougly total circle.
#define fHD6VignetteColorDistort	0.0     //[0.0 to 5.0] Distorts the colors.
#define fHD6VignetteContrast		0.8	//[0.0 to 20.0] Contrast of vignette curve.
#define fHD6VignetteBorder		0	//[0.0 to 5.0] Vignette Border factor.

//STANDARDVIGNETTE
#define fVignetteAmount			1.25	//[0.0 to 5.0] Amount of vignette color change.
#define fVignetteCurve			1.2	//[0.0 to 5.0] Curve of vignette color change.
#define fVignetteRadius			0.9	//[0.0 to 5.0] Radius from center where vignette color change kicks in.
